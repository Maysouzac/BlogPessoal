...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario(){
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity <Usuario>(new Usuario(0L, "Paulo Antunes","Paulo_Antunes@email.com","12345678","-"));
	...
	public void deveMostrarTodosUsuarios(){
		...
		usuarioService.cadastrarUsuario(new Usuario(0L,
				"Sabrina Sanches", "sabrina_sanches@email.xom.br", "sabrina123", "-"));
		
		usuarioService.cadastrarUsuario(new Usuario(0L,
				"Ricardo Marques", "ricardo_marques@email.xom.br", "ricardo123", "-"));
